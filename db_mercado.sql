...
CREATE TABLE `core_producto` (
  ...
  KEY `core_producto_categoria_id_65b2d0af_fk_core_categoria_id` (`categoria_id`),
  CONSTRAINT `core_producto_categoria_id_65b2d0af_fk_core_categoria_id` FOREIGN KEY (`categoria_id`) REFERENCES `core_categoria` (`id`),
...
INSERT INTO `core_producto` VALUES (1,'Coca Cola 3L','COC-001',15.00,10,1,NULL);
...
-- Dump completed on 2025-11-30  7:27:11
